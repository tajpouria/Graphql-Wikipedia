...
export type Actions = {
  ...
  opensearch: Array<Maybe<Scalars['String']>>,
};
...
export type ActionsResolvers<ContextType = any, ParentType extends ResolversParentTypes['Actions'] = ResolversParentTypes['Actions']> = {
  opensearch?: Resolver<Array<Maybe<ResolversTypes['String']>>, ParentType, ContextType, RequireFields<ActionsOpensearchArgs, 'searchString'>>,
};
...
export type ActionsResolvers<ContextType = any, ParentType = $ElementType<ResolversParentTypes, 'Actions'>> = {
  opensearch?: Resolver<Array<?$ElementType<ResolversTypes, 'String'>>, ParentType, ContextType, $RequireFields<ActionsOpensearchArgs, { searchString: * }>>,
};
